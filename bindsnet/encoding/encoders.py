...
class PoissonNormalizedEncoder(Encoder):
    def __init__(self, maxrate: int, time: int, dt: float = 1.0, approx: bool = False, **kwargs):
        # language=rst
        """
        ...
        """
        super().__init__(maxrate, time, dt=dt, approx=approx, **kwargs)

        self.enc = encodings.poisson_normalized
